...
const dummyData = {
    ...
    results: [{
        ...
        },
        {
            ...
            overview: "Diabolik nearly gets caught in Inspector Ginko's latest trap, leaving his partner in crime Eva Kant behind in the escape. Furious, Eva offers Ginko her help in capturing the King of Terror, but the former has to face the return of an old flame of his: Altea, Duchess of Vallenberg.",
            popularity: 1188.531,
...
searchInput.addEventListener("keyup", (e) => {
    if (e.target.value == "") {
        ...
        removeAll();
        render(dummyData.results.filter((item) => item.title.toLowerCase().includes(e.target.value.toLowerCase())));
    }
});
