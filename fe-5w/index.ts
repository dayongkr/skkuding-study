...
const wrapper:HTMLDivElement = document.getElementById("sub-wrapper") as HTMLDivElement;

const render = (data: Array<movieData>) => {
  data.forEach((item: movieData) => {
...
const searchButton: HTMLButtonElement = document.getElementById("search_button") as HTMLButtonElement;
const searchBackButton: HTMLButtonElement= document.getElementById("search-back-button") as HTMLButtonElement;
const titleWrapper: HTMLDivElement = document.getElementById("title-wrapper") as HTMLDivElement;
const searchWrapper: HTMLDivElement = document.getElementById("search-wrapper") as HTMLDivElement;
const searchInput: HTMLInputElement= document.getElementById("search_input") as HTMLInputElement;
...
searchBackButton.addEventListener("click", () => {
  titleWrapper.classList.remove("hide");
...
searchInput.addEventListener("keyup", (e) => {
  if ((<HTMLInputElement>e.target).value == "") {
    ...
    removeAll();
    render(
      dummyData.results.filter((item: movieData) =>
        item.title.toLowerCase().includes((<HTMLInputElement>e.target).value.toLowerCase())
      )
    );
  }
});
